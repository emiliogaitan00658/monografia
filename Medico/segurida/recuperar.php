...
if (!empty($row)) {
    ...
    $mensaje .= "\r\n";
    /* $mensaje .= "http://www.orthodentalnic.com/Medico/pacientes/clinica.php?indmedico=".$pinunico."\r\n";*/
    ...
    $mensaje .= "Fecha: " . $fecha . "\r\n";
    $mensaje .= "Hora: " . $hora . "\r\n";
    $mensaje .= "Problemas al ingresar reportar: soportesistemaradiografiadigital@gmail.com"."\r\n";
