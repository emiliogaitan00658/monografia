...
<div class="container center-align">
    <h5 class="left-align"><i class="icon-compass2 modal-title red-text"> </i>Bienvenido Sucursal <?php echo $rows["nombre_sucursal"]; ?></h5>
    <h5 class="padii text-info">Menu Principal</h5>
    <hr>

    <div class="lk">
        <a href="Medico/pacientes/sucursales.php" class="btn-link">Publicar Estudio</a>
    </div>
    <hr>
